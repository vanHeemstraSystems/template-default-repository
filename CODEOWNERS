...
# modifies JS files, only @js-owners and not the global
# owner(s) will be requested for a review.
*.js    @js-owners #This is an inline comment.
...
# In this example, @log-owners own any files in the build/logs
# directory at the root of the repository and any of its
# subdirectories.
/build/logs/ @log-owners
...
# In this example, @docs-owners owns any file in the `/docs`
# directory in the root of your repository and any of its
# subdirectories.
/docs/ @docs-owners

# In this example, any change inside the `/scripts` directory
# will require approval from @docs-owners or @vanHeemstraSystems.
/scripts/ @docs-owners @vanHeemstraSystems
...
# In this example, @vanHeemstraSystems owns any file in the `/apps`
# directory in the root of your repository except for the `/apps/github`
# subdirectory, as this subdirectory has its own owner @docs-owners
/apps/ @vanHeemstraSystems
/apps/github @docs-owners
